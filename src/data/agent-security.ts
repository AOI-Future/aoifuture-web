...
export const notationTerms = [
  ...
  },
  {
    ...
    en: 'Control',
    question: '何で防ぐ？',
    description: '脅威に対して置く防御策の種類です。CT-01からCT-15まであり、特定製品の設定名ではなく、最小権限やサンドボックスなど、防御の考え方を表します。',
    exampleId: 'CT-05',
    example: '最小権限と職務分離',
  },
  {
    ...
    en: 'Requirement',
    question: '何が満たされればよい？',
    description: 'コントロールを、ある／ない、満たす／満たさないと判定できる文章にしたものです。REQ-000からREQ-054までの安定した識別子を使い、SHALLは必須、SHOULDは理由を記録したうえで判断する強い推奨です。',
    exampleId: 'REQ-011',
  ...
  },
  {
    ...
    question: 'どう確かめる？',
    description: '要件を実際に確認し、PASS／FAIL／SKIPとして記録するテストです。Sは静的、Dは動的、Eは証拠・ログ、Aは監査・アテステーションを表します。',
    exampleId: 'VT-S-011-SHELL',
    example: 'shellツールの設定を静的に確認する',
  },
] as const;
